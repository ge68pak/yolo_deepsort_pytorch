...
class YOLOv3(object):
    ...
    def __call__(self, ori_img):
        ...
        with torch.no_grad():
            ...
            out_boxes = self.net(img)      # image -> output (before yolo predict layer)

            # output(predicted offset + anchor information) -> predicted BBox [x1, y1, x2, y2, det_confs, cls_confs, cls_max_ids]
